...
public class FiltersITests {
    ...
    @RegisterExtension
    static WireMockExtension FORWARD_SERVICE = WireMockExtension.newInstance()
            .options(WireMockConfiguration.wireMockConfig().port(20001))
            .build();
    @RegisterExtension
    static WireMockExtension AUTH_SERVICE = WireMockExtension.newInstance()
    ...
    void test_secured_endpoint() throws Exception {
        Assertions.assertThrowsExactly(HttpClientErrorException.Unauthorized.class,
    ...
    void test_default_flow() {
        ...
        String body = "{ \"call\":\"ok\"}";
        FORWARD_SERVICE.stubFor(get(urlEqualTo("/api/v1/categories"))
                .willReturn(
                        aResponse()
        ...
        ResponseEntity<String> response = restTemplate.exchange("/api/v1/categories", HttpMethod.GET, entity, String.class);
        ...
        then(this.messageKafkaTemplate).should(times(2)) .sendDefault(keyCaptor.capture(), payloadCaptor.capture());
    ...
    void test_rate_limit() {
        ...
        // then
        Assertions.assertThrowsExactly(HttpClientErrorException.TooManyRequests.class,
    ...
    void test_signin_flow() throws JsonProcessingException {
        ...
        AUTH_SERVICE.stubFor(post(urlEqualTo("/api/v1/users/validate"))
        ...
        ResponseEntity<SignInResponse> response = restTemplate.exchange("/api/v1/auth/signin", HttpMethod.POST, entity, SignInResponse.class);
